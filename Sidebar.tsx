      ...
      <aside className={`fixed md:sticky top-0 left-0 z-50 flex flex-col w-64 bg-white border-r border-slate-100 p-4 md:p-5 space-y-3 md:space-y-4 h-screen overflow-y-auto transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
        <div className="flex items-center justify-between shrink-0 mb-1">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg font-black tracking-tighter text-slate-800">CulinaryAI</span>
          </div>
        ...
        <div className="mt-auto p-4 bg-emerald-600 rounded-[1.5rem] text-white shadow-lg shadow-emerald-100/50 shrink-0">
          <p className="text-[9px] font-black uppercase tracking-widest opacity-60 mb-1">Chef Mode</p>
          <p className="text-[11px] font-bold leading-tight">Smart kitchen, zero waste.</p>
        </div>
      </aside>
    </>
  );
